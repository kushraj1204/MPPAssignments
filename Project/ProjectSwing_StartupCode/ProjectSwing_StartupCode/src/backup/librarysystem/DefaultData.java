 ...
 * @since Oct 22, 2004
 *        <p>
 *        Class Description: This class stores "dummy data" for the Gui. In the
 *        final project, this class should not be used, but should be replaced
 *        by appropriate accesses of the real data. <br>
...
public class DefaultData {
	...
	// field names for MaintainProductCatalog and AddEditProduct; enumerated
	// constants used for accessing
	...
	private String[][] cartItemsData = { { GARDEN_OF_RAMA, "2", "50", "100" }, { PANTS, "1", "25", "25" },
			{ TSHIRTS, "4", "15", "40" } };
	...
	private final static String[][] DEFAULT_BOOKS = { { GONE_WITH_THE_WIND }, { MESSIAH_OF_DUNE }, { GARDEN_OF_RAMA } };
	/** Each row of this 2D array represents a row in the clothes table */
	private final static String[][] DEFAULT_CLOTHES = { { PANTS }, { TSHIRTS }, { SKIRTS } };
	...
	// initialize the HashMap before an instance is created so that the data is
	...
	private String[][] selectOrderDefaultData = { { "XB13425", "May 1, 2003", "$300.00" },
			{ "ZZ13425", "May 2, 2003", "$400.00" }, { "BB13425", "May 3, 2003", "$500.00" } };
	...
	private String[][] viewOrderDetailsDefaultData = { { "Shirt", "25.00", "2", "50.00" },
			{ "Belt", "18.50", "1", "18.50" }, { "Extreme Programming Guide", "22.00", "4", "88.00" } };
	...
	private static String[][] prodCatalogBooks = { { "Gone with the Wind", "12.00", "10-12-2001", "20" },
			{ "Messiah of Dune", "43.00", "05-10-2001", "100" }, { "Garden of Rama", "52.00", "10-12-1991", "30" } };
	private static String[][] prodCatalogClothes = { { "Pants", "12.00", "10-12-2001", "20" },
			{ "T-Shirts", "43.00", "05-10-2001", "100" }, { "Skirts", "52.00", "10-12-1991", "30" } };
	private static String[][] Users1 = { { "Admin", "111" }, { "Both", "111" } };

	private static HashMap<String, String[][]> productCatalogChoices;
	private static HashMap<String, String[][]> Users;

	public List<String[]> getuuuu() {
	...
	private static String[][] catalogTypes = { { BOOKS }, { CLOTHES } };
	...
	private static String[][] shipAddresses = { { "1607 Granville Ave", "Fairfield", "IA", "52556" } };
	...
	///////////// FinalOrder data
	private String[][] finalOrderData = { { "Garden of Rama", "2", "50", "100" }, { "Pants", "1", "25", "25" } };
	...
	private String[][] mainCatalogData = { { DefaultData.BOOKS }, { DefaultData.CLOTHES } };
