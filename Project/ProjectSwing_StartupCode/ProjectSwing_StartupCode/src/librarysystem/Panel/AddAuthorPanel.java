...
public class AddAuthorPanel {
    ...
    public static Component getNewAuthorPanel(JFrame frame) {
        return getAuthorPanel(frame);
    }

    private static Component getAuthorPanel(JFrame frame) {
        return new librarysystem.Panel.Author();
    }
...
//		AllIDsLabel.setBounds(42, 10, 319, 36);
        ...
        btnAddAuthor.addActionListener(e -> {
            ...
            if (fN.equals("") || lN.equals("") || street.getText().equals("") || city.getText().equals("")
                ...
                Author author = new Author(fN, lN, phone, address, bio.getText(), UUID.randomUUID().toString());
                authors.add(author);
