...
import business.service.CheckoutService;
import business.service.Response;
	...
	public void init() {
		...
		btnCheckout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Response rsp=CheckoutService.checkoutBook(txtMemberId.getText(), txtISBN.getText());

/*					BookCopy bc = ci.checkoutBook(txtMemberId.getText(), txtISBN.getText()); */
					JOptionPane.showMessageDialog(parentFrame, rsp.getMessage());
