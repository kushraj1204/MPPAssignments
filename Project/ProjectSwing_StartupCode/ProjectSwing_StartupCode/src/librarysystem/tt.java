 ...
 *
 */
public class tt extends JWindow implements ParentWindow {
	...
	class EditButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			if (selectedRow >= 0) {
				...
				productInfo.setProperty(fldNames[columnIndex], (String) model.getValueAt(selectedRow, columnIndex));
...
//        		editProd.setVisible(true);
				...
				JOptionPane.showMessageDialog(tt.this, ERROR_MESSAGE, ERROR, JOptionPane.ERROR_MESSAGE);
	...
	class DeleteButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			if (selectedRow >= 0) {
				...
				JOptionPane.showMessageDialog(tt.this, "Need to write code for this!", "Information",
