...
public class PortalWindow extends JFrame implements LibWindow {
	...
	public static String[] funcItems = { "Home", "Member", "   Add new members", "   View Checkouts(remove)", "All members",
			"Book", "   Add new books", "   Search Overdue Books","   Add new copies","   Check out" };
